...
export const getBlocks = async (total_blocks, pageIndex, paramester) => {
    ...
    return store.dispatch(getListBlocks(list_blocks));
}

export const getTransactions = async (total_blocks, total_txs, pageIndex, paramester) => {
    ...
    return store.dispatch(getDataTransactions(transactions));
}